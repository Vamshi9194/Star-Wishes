...
const Wedding = () => {
  ...
  return (
    <View style={styles.wedding}>
      <View style={[styles.homeIndicator, styles.weddingItemLayout]}>
        <View style={styles.homeIndicator1} />
      </View>
      <Image
        style={[styles.weddingChild, styles.weddingPosition]}
        resizeMode="cover"
        source={require("../assets/group-1717.png")}
      />
      <Image
        style={[styles.weddingItem, styles.weddingPosition]}
        resizeMode="cover"
      ...
      <Image
        style={[styles.weddingInner, styles.weddingPosition]}
        resizeMode="cover"
        source={require("../assets/ellipse-18.png")}
      />
      <Text style={[styles.wedding1, styles.wedding1Typo]}>Wedding</Text>
      <View style={[styles.homeIndicator, styles.weddingItemLayout]}>
        <View style={styles.homeIndicator1} />
      </View>
      <Text style={[styles.signUpOr, styles.wedding1Typo]}>
        Sign Up or Register
      </Text>
      ...
      <Image
        style={[styles.groupIcon, styles.weddingPosition]}
        resizeMode="cover"
      ...
      <Text style={[styles.weddingDate, styles.april1985Position]}>
        Wedding Date
      </Text>
      <Image
        style={[styles.weddingChild1, styles.vectorIconLayout]}
        resizeMode="cover"
