...
const NewBorn = () => {
  ...
  return (
    <View style={styles.newBorn}>
      <View style={[styles.homeIndicator, styles.newBornItemLayout]}>
        <View style={styles.homeIndicator1} />
      </View>
      <Image
        style={[styles.newBornChild, styles.newPosition]}
        resizeMode="cover"
        source={require("../assets/group-1717.png")}
      />
      <Image
        style={[styles.newBornItem, styles.newPosition]}
        resizeMode="cover"
      ...
      <Image
        style={[styles.newBornInner, styles.newPosition]}
        resizeMode="cover"
        source={require("../assets/ellipse-18.png")}
      />
      <Text style={[styles.newBorn1, styles.newBorn1Typo]}>New Born</Text>
      <View style={[styles.homeIndicator, styles.newBornItemLayout]}>
        <View style={styles.homeIndicator1} />
      </View>
      <Text style={[styles.signUpOr, styles.newBorn1Typo]}>
        Sign Up or Register
      </Text>
      ...
      <Image
        style={[styles.groupIcon, styles.newPosition]}
        resizeMode="cover"
      ...
      <Text style={[styles.newBornDate, styles.april1985Position]}>
        New born Date
      </Text>
      <Image
        style={[styles.newBornChild1, styles.vectorIconLayout]}
        resizeMode="cover"
